"""This file is a copy of the package kml2geojson by Alexander Raichev
See : https://pypi.python.org/pypi/kml2geojson/3.0.4 
"""
...
if __name__ == '__main__':
    convert(os.path.join('..','data','NLPostcodes4PP.kml'), os.path.join('..','data','NLPostcodes4PP'))